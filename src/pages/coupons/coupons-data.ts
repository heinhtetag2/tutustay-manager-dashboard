...
/** Derived display status — not stored, computed from dates + usage + the enabled switch. */
export type CouponStatus = 'Active' | 'Scheduled' | 'Expired' | 'Disabled';

export const COUPON_STATUSES: CouponStatus[] = ['Active', 'Scheduled', 'Expired', 'Disabled'];
...
export interface Coupon {
  ...
  usageLimit: number;
  usedCount: number;
  /** Manager on/off switch, independent of the date window. */
  enabled: boolean;
  createdAt: string;
}
...
export function couponStatusClass(status: CouponStatus): string {
  switch (status) {
    ...
    case 'Disabled': return 'bg-[var(--warning-tint)] text-[var(--warning-strong)]';
  }
}
...
/** Derive the display status from the enabled switch, validity window, and usage. */
...
export const DEMO_COUPONS: Coupon[] = [
  {
    ...
    usageLimit: 200, usedCount: 47, enabled: true, createdAt: '2026-05-20T09:00:00',
  },
  {
    ...
    usageLimit: 0, usedCount: 312, enabled: true, createdAt: '2026-01-02T08:00:00',
  },
  {
    ...
    usageLimit: 100, usedCount: 88, enabled: true, createdAt: '2026-05-10T11:30:00',
  },
  {
    ...
    usageLimit: 150, usedCount: 0, enabled: true, createdAt: '2026-06-01T14:00:00',
  },
  {
    ...
    usageLimit: 100, usedCount: 64, enabled: true, createdAt: '2026-02-20T10:00:00',
  },
  {
    ...
    usageLimit: 20, usedCount: 20, enabled: true, createdAt: '2026-04-25T16:20:00',
  },
  {
    ...
    usageLimit: 50, usedCount: 12, enabled: false, createdAt: '2026-05-29T09:00:00',
  },
  {
    id: 'cp8', code: 'LOYALTY5', description: 'Returning-guest reward — 5% off, always on.',
    discountType: 'Percentage', value: 5, minSpend: 0,
    startsAt: '2026-01-01', expiresAt: '2026-12-31', roomTypes: [],
    usageLimit: 0, usedCount: 540, enabled: true, createdAt: '2026-01-02T08:05:00',
  },
  {
    ...
    usageLimit: 300, usedCount: 5, enabled: true, createdAt: '2026-06-01T07:40:00',
  },
];
